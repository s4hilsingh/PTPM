...
<body>
    <script type="text/javascript" src="', $settings['theme_url'], '/scripts/jsized.snow.min.js"></script>';
}
	...
	<div id="footer">
	 ...
	 echo '
		...
		<div class="my_copyright">
            <strong>Armageddon</strong> by <a href="http://www.skin-box.com/" target="_blank">Skin-Box</a><a class="backtop" href="#"></a>
