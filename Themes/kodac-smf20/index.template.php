...
<head>';
	...
	echo '
	<link href="http://fonts.googleapis.com/css?family=Open+Sans:400,600,700|Open+Sans+Condensed:700" rel="stylesheet" type="text/css" />';
...
echo '
	<div id="header-container">
		<div id="header">
			<div class="wrapper">
				<a id="logo" title="' . $context['forum_name'] . '" href="'.$scripturl.'"></a>
				<div id="account">';
				...
				echo '
					...
					echo '
						<li>', $context['user']['avatar']['image'], '</li>';

					echo '				
						<li class="greeting">', $txt['member_greeting'], ' <span>', $context['user']['name'], '</span></li>';
				...
				echo '
					<ul>
						<li class="btn-login"><a href="', $scripturl, '?action=login">', $txt['login'], '</a></li>
						<li class="btn-register"><a href="', $scripturl, '?action=register">', $txt['register'], '</a></li>
					</ul>';
				}
			echo '
				</div>
	...
	<div id="footer">
		<div class="wrapper">
			<a class="backtop" href="#"></a>		
					',theme_copyright(),' | ' , $txt['ds_copyright'], '
		</div>
	</div>';
}
