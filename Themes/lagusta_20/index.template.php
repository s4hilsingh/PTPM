...
<head>';
	...
	echo '
	<!--[if IE 6]>
		<script src="', $settings['theme_url'], '/js/DD_belatedPNG.js"></script>
		<script>
...
<div id="topbar" class="pngbg">
	<div class="wrapper">
		<div id="toplinks">
			...
			if (!empty($settings['show_rss_icon']))
			echo '
				<li><a class="rss_icon pngbg" href="' . $scripturl . '?action=.xml;type=rss"></a></li>';
		...
		<div id="content">
			<div id="main_content_top">
				...
				if ($context['user']['is_logged'])
				{
					...
					echo '
						<p class="memb_avatar">', $context['user']['avatar']['image'], '</p>';
						
					echo '
						<p class="memb_greeting">', $txt['member_greeting'], ' ', $context['user']['name'], '</p>';	
					...
					echo '
						...
						if ($context['allow_pm'])
						echo '
							<li><a href="', $scripturl, '?action=pm">', $txt['pm'], ' <span class="pm_count">', $context['user']['messages'], ' <strong>(', $context['user']['unread_messages'] , ')</strong></span></a></li>';

						echo '
							<li><a href="', $scripturl, '?action=unread">' , $txt['show_unread'], '</a></li>
							<li><a href="', $scripturl, '?action=unreadreplies">' , $txt['show_replies'], '</a></li>
							<li><a class="logout" href="', $scripturl, '?action=logout;sesc=', $context['session_id'], '">' , $txt['logout'], ' <strong>&gt;</strong></a></li>';
				...
				echo '
					<ul>
						<li class="login_icon"><a href="', $scripturl, '?action=login"><span class="uppertext">', $txt['login'], ' <strong>&gt;</strong></span><span>', $txt['login_desc'], '</span></a></li>
						<li class="signup_icon"><a href="', $scripturl, '?action=register"><span class="uppertext">', $txt['register'], ' <strong>&gt;</strong></span><span>', $txt['signup_desc'], '</span></a></li>
					</ul>';
				}
...
function template_body_below()
{
	...
	echo '
		...
		echo '			
			...
			<div id="ds_copyright">
				<span class="copyright"><a href="http://www.dzinerstudio.com" target="_blank"><strong>laGusta</strong> by DzinerStudio</a></span>
				<span class="backtop"><a href="#" class="back_top">Back To Top</a></span>
			</div>
			<div class="clr"></div>
		</div>';
}
