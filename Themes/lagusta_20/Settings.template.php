...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		array(
			'id' => 'show_date_time',
			'label' => $txt['show_date_time'],
		),
		array(
			'id' => 'toplink_but1',
			'label' => $txt['toplink_but1'],
			'type' => 'text',
		),
		array(
			'id' => 'toplink_url1',
			'label' => $txt['toplink_url1'],
			'type' => 'text',
		),
		array(
			'id' => 'toplink_but2',
			'label' => $txt['toplink_but2'],
			'type' => 'text',
		),
		array(
			'id' => 'toplink_url2',
			'label' => $txt['toplink_url2'],
			'type' => 'text',
		),
		array(
			'id' => 'toplink_but3',
			'label' => $txt['toplink_but3'],
			'type' => 'text',
		),
		array(
			'id' => 'toplink_url3',
			'label' => $txt['toplink_url3'],
			'type' => 'text',
			'description' => $txt['toplinks_desc'],
		),
		array(
			'id' => 'show_rss_icon',
			'label' => $txt['show_rss_icon'],
		),
		array(
