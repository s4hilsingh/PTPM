		...
		echo '							
			...
			<div id="topbar">
				<div id="userbox">
					...
					{
					echo '
						<li>', $txt['member_greeting'], ' ', $context['user']['name'], '!</li>
						<li><a href="', $scripturl, '?action=unread">' , $txt['show_unread'], '</a></li>
						<li><a href="', $scripturl, '?action=unreadreplies">' , $txt['show_replies'], '</a></li>
						<li><a class="logout" href="', $scripturl, '?action=logout;sesc=', $context['session_id'], '"></a></li>';
					}
					...
					{ 
					echo '					
						<li><a class="login" href="', $scripturl, '?action=login"></a></li>
						<li><a class="register" href="', $scripturl, '?action=register"></a></li>';
					}
			echo'
				</ul></div>
				<div id="search">
...
function template_menu()
{
	...
	foreach ($context['menu_buttons'] as $act => $button)
	{
		echo '
				<li id="button_', $act, '">
					<a class="', $button['active_button'] ? 'active ' : '', 'daddy" href="', $button['href'], '"', isset($button['target']) ? ' target="' . $button['target'] . '"' : '', '>
