		...
		echo '
			...
			<div id="toolbar">
				<div id="quicknav">
					...
					echo '
						<li class="date-time">', $context['current_time'],'	</li>';
				...
				echo '
					...
					echo '
						<li class="avatar-img"><a href="' , $scripturl , '?action=profile">', $context['user']['avatar']['image'], '</a></li>';
				...
				{
					echo '<span>', $txt['guest_welcome'], '</span>';
				}
...
echo '
	<div id="footer">
		<div id="social-links">
			...
			echo '
				<li class="dribble"><a href="', $settings['dribble_url'] , '" title="Dribble" target="_blank"></a></li>';
		...
		<div id="copyright">
			<p>',theme_copyright(),' | ' , $txt['ds_copyright'], '</p>';
