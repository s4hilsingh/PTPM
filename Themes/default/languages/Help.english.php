...
$helptxt['email_template_help_global_presets'] = 'Global Preset Variables are simply shortcuts which can be accessed in any email template.<br /><br /><strong>List of Global Presets</strong><br /><div style="font-size: 6pt;">{FORUMNAME} => '. $context['forum_name']. '<br />{SCRIPTURL} => '. $scripturl. '<br />{THEMEURL} => '. $settings['theme_url']. '<br />{IMAGESURL} => '. $settings['images_url']. '<br />{DEFAULT_THEMEURL} => '. $settings['default_theme_url']. '<br />{REGARDS} => '. $txt['regards_team']. '</div><br /><em>Shortcut => Output</em>';
$helptxt['email_template_help_send_test_email'] = 'Send Test Email allows you to select a template, and input a recipient\'s email address to test the output of your Custom Email Templates.';
