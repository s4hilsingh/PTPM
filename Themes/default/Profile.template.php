	...
	<div id="basicinfo">
		<div class="windowbg">
			...
			<div class="content flow_auto">
					<div class="username"><h4>', $context['member']['name'], ' <span class="position">', (!empty($context['member']['group']) ? $context['member']['group_stars'] : ''), '</span></h4></div>				
					', $context['member']['avatar']['image'], '
					<div class="membergroupc"><span class="memposition">', $context['member']['additional_group_stars'], '</span></div>
				<ul class="reset">';
