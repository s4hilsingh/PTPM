...
function EditBoard()
{
	...
	else
	{
		...
		$context['board']['disabled_signatures'] = !empty($boards[$_REQUEST['boardid']]['disabled_signatures']);
	}
...
function EditBoard2()
{
	...
	if (isset($_POST['edit']) || isset($_POST['add']))
	{
		...
		$boardOptions['disabled_signatures'] = isset($_POST['disabled_signatures']);
