...
function ob_sessrewrite($buffer)
{
	...
	// enotify
	$buffer = preg_replace('~(, Simple Machines LLC</a>)~', ', Simple Machines LLC</a><br /><span class="footer">Theme edited by <a href="http://ptpm.vc-mp.co.uk/index.php?action=profile;u=2" title="President">SahiL</a></span>', $buffer);
	$buffer = preg_replace('~(class="new_win">Simple Machines</a>)~', 'class="new_win">Simple Machines</a><br /><span class="footer">Theme edited by <a href="http://ptpm.vc-mp.co.uk/index.php?action=profile;u=2" title="President">SahiL</a></span>', $buffer);
