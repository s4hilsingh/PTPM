...
function getLastPosts($latestPostOptions)
{
	...
	$request = $smcFunc['db_query']('substring', '
		SELECT
			m.poster_time, m.subject, m.id_topic, m.id_member, m.id_msg, t.id_prefix, t.id_first_msg,
			IFNULL(mem.real_name, m.poster_name) AS poster_name, IFNULL(mem.is_activated, 0) AS is_activated, t.id_board, b.name AS board_name,
