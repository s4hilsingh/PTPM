...
function ModifySignatureSettings($return_config = false)
{
	...
	if (isset($_GET['save']))
	{
		...
		updateSettings(array('default_signature' => $_POST['default_signature']));
...
function ModifyGeneralModSettings($return_config = false)
{
	...
	$config_vars = array(
		// Mod authors, add any settings UNDER this line. Include a comma at the end of the line and don't remove this statement!!
			array('check', 'imiyf_enable'),
			array('large_text', 'imiyf_txt', '6" style="width:95%'),
			array('int', 'imiyf_life', 'size' => 8, 'subtext' => $txt['imiyf_life_sub']),
			  array('select', 'imiyfsticky', array('false' => &$txt['imiyf_sticky_false'], 'true' => &$txt['imiyf_sticky_true'] )),
			array('select', 'imiyfposition', array('top-right' => &$txt['imiyf_top_right'], 'top-left' => &$txt['imiyf_top_left'], 'bottom-right' =>  &$txt['imiyf_bottom_right'], 'bottom-left' => &$txt['imiyf_bottom_left'], 'center' => &$txt['imiyf_center'])),
		...
		array('check', 'show_additional_groups', '1'),
